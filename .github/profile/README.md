...
<p align="center">
  <a href="https://github.com/PT-ZYNTRIX-ARTIFICIAL-INTELLIGENCE">
    <img src="https://img.shields.io/badge/ORGANIZATION-PT%20ZYNTRIX%20AI-0A2647?style=for-the-badge&logo=github&logoColor=white" alt="Organization" />
  </a>
  <img src="https://img.shields.io/badge/ENGINEERING-ENTERPRISE%20GRADE-FFFFFF?style=for-the-badge&logo=codefactor&logoColor=0A2647&labelColor=F1F5F9" alt="Enterprise Grade" />
  <img src="https://img.shields.io/badge/SECURITY-BY%20DESIGN-DC2626?style=for-the-badge&logo=owasp&logoColor=white" alt="Security by Design" />
  <img src="https://img.shields.io/badge/ARCHITECTURE-CLEAN%20%2B%20SOLID-144272?style=for-the-badge&logo=diagramsdotnet&logoColor=white" alt="Clean Architecture" />
</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/tRPC-2563EB?style=for-the-badge&logo=trpc&logoColor=white" alt="tRPC" />
...
<p align="center">
  <img src="./assets/pulse-line.svg" width="92%" alt="Zyntrix engineering pulse" />
</p>
...
```mermaid
flowchart TB
    U[Users / Operators / Residents] --> EDGE[CDN / Edge Security]
    EDGE --> UI[Web / PWA Experience]

    UI --> APP[Application Layer]
    APP --> DOMAIN[Domain Layer]

    APP --> AUTH[Identity & Authorization]
    APP --> DATA[Data Access Ports]
    APP --> INT[Integration Ports]
    APP --> AI[AI / Analytics Ports]

    DATA --> DB[(PostgreSQL / Managed Data)]
    INT --> EXT[External Services]
    AI --> PY[Python Data & ML Runtime]
...
<p>
  <a href="https://github.com/PT-ZYNTRIX-ARTIFICIAL-INTELLIGENCE/EPS-EXPERIENCE">
    <img src="https://img.shields.io/badge/VIEW%20REPOSITORY-EPS--EXPERIENCE-0A2647?style=for-the-badge&logo=github&logoColor=white" alt="EPS Experience repository" />
  </a>
</p>
...
<p>
  <a href="https://github.com/PT-ZYNTRIX-ARTIFICIAL-INTELLIGENCE/SIGAP-GIZI">
    <img src="https://img.shields.io/badge/VIEW%20REPOSITORY-SIGAP--GIZI-0A2647?style=for-the-badge&logo=github&logoColor=white" alt="SIGAP GIZI repository" />
  </a>
</p>
...
flowchart TB
    ...
    CODE --> TYPE[Type Safety]
    CODE --> TEST[Unit Tests]
    CODE --> SEC[Security Checks]
    CODE --> BUILD[Production Build]
    ...
    GATE -->|PASS| REVIEW[Human / Automated Review]
...
gitGraph
    ...
    branch feature/controlled-change
    checkout feature/controlled-change
    commit id: "implementation"
    checkout staging
    merge feature/controlled-change id: "PR verified"
    checkout main
    merge staging id: "release gate"
```
...
quadrantChart
    ...
    x-axis Low Operational Value --> High Operational Value
    y-axis Low Risk --> High Risk
    quadrant-1 Govern Carefully
    quadrant-2 Avoid / Redesign
    quadrant-3 Keep Simple
    quadrant-4 Prioritize
    "Critical auth change": [0.82, 0.88]
    "UI micro-animation": [0.38, 0.20]
    "Query optimization": [0.79, 0.42]
    "Unnecessary abstraction": [0.24, 0.61]
    "Observability": [0.91, 0.36]
```
...
<p align="center">
  <img src="./assets/dna-strip.svg" width="100%" alt="Zyntrix organization DNA" />
</p>
...
<p align="center">
  <img src="./assets/footer-terminal.svg" width="100%" alt="Zyntrix engineering footer" />
</p>
